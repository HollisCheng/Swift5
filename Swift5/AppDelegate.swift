...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if(getAppLanguage()==nil){
            ...
            }else if(Locale.preferredLanguages[0]==Constants.zh_Hans){
                saveUserDefaultsString(key: Constants.kAppLanguage, value: Constants.TChi)
            }else if(Locale.preferredLanguages[0]==Constants.zh_Hant){
                saveUserDefaultsString(key: Constants.kAppLanguage, value: Constants.TChi)
            }else{
                saveUserDefaultsString(key: Constants.kAppLanguage, value: Constants.en)
            }
        }else{
            print("applanguage="+getAppLanguage()!)
        }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Swift5")
